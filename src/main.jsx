...
createRoot(document.getElementById('root')).render(
  <StrictMode>
    ...
    <div className=' flex justify-center flex-col lg:mr-80 lg:ml-80'>
      <p className='flex text-2xl sm:text-5xl font-bold text-white mb-5 duration-800 justify-center xl:justify-start'>Skills 💡</p>
      <span className='hidden xl:inline lg:w-full h-2 bg-gradient-to-tl from-indigo-700 to-blue-400'></span>
      <Competecences/>
    </div>
  </StrictMode>
)
